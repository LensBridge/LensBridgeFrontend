 ...
 *   - locally: defaults to ../LensBridgeBackend/openapi.yaml, matching a sibling checkout
...
if (!existsSync(spec)) {
  ...
  console.error('Check out LensBridgeBackend beside this repo, or set OPENAPI_SPEC.');
  process.exit(2);
}
